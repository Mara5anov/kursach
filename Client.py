...
# server_ip = 'localhost'
server_ip = str(config['SETTINGS']['server_ip'])
port = int(config['SETTINGS']['port'])
my_name = config['SETTINGS']['my_name']
WIDTH_WINDOW = int(config['SETTINGS']['WIDTH_WINDOW'])
HEIGHT_WINDOW = int(config['SETTINGS']['HEIGHT_WINDOW'])
